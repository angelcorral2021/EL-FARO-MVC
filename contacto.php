...
<head>
    ...
    <link herf="https://fonts.googleapis.com/css?family=Roboto:300,300i,400,400i,500,500i" rel="stylesheet">
...
<body>
    ...
    <div class="container formulario-contacto">
        <h1 class="text-center my-5 text-uppercase text-danger">Formulario de Contacto</h1>
        <form name="formulario" action="Controllers/formulario_contacto.php" method="POST" ><!--Controllador de formulario de contacto-->
